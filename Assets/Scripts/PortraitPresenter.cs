...
{
    [SerializeField] private CharacterPortraitEntry[] characters;
    ...
    {
        CharacterPortraitEntry match = System.Array.Find(characters, entry =>
            entry.characterName.Equals(line.CharacterName, System.StringComparison.OrdinalIgnoreCase));
